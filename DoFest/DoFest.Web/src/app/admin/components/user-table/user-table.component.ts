...
export class UserTableComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.subs.push(this.adminService.getUserTypes().subscribe((data: HttpResponse<any>) =>{
      ...
      this.subs.push(this.adminService.getUsers().subscribe((data: HttpResponse<any>) =>{
        if(data.status/100 != 2){
