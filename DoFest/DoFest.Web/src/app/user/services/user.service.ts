...
export class UserService {
  ...
  public changePassword(data:NewPasswordModel ): Observable<HttpResponse<unknown>> {
    return this.httpClient.put(this.routeService.getRoute("authentication","change password"),
