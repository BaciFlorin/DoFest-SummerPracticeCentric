...
export class RouteService {
  ...
  private routes = {
    ...
    "admin": {
      ...
      "change userType" : (userId:string) => `admin/user/${userId}/userType/toggle`
    },
    "authentication" : {
      "login" : "auth/login",
    ...
    "comment": {
      ...
      "delete" : (activityId:string, commentId:string) => `activities/${activityId}/comments/${commentId}`
    },
    "notification" : {
    ...
    "photo": {
      ...
      "delete" : (activityId:string, commentId:string) => `activities/${activityId}/photos/${commentId}`
    },
    "rating": {
